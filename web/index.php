                        ...
                        <div class="text-end">
                            <div class="row shadow bg-white rounded p-4 pt-5 pb-5">
                                <?php if ($chiffres["cumul_sortie_campagne_n_1"]): ?>
                                    <div class="col">
                                        <div class="chiffre">
                                            <h3 class="mb-0 disable-uppercase"><?php echo number_format($chiffres["cumul_sortie_campagne_n_1"], 0, ',', '&nbsp;'); ?> hl</h3>
                                ...
                                <?php if ($chiffres["cumul_sortie_campagne_en_cours"]): ?>
                                    <div class="col">
                                        <div class="chiffre">
                                            <h3 class="mb-0 disable-uppercase"><?php echo number_format($chiffres["cumul_sortie_campagne_en_cours"], 0, ',', '&nbsp;'); ?> hl <span title="Evolution par rapport à la campagne précédente" class="fs-6 badge <?php if($chiffres["evolution_cumul_sortie_campagne_en_cours"] >= 0):?>bg-success<?php else: ?>bg-danger <?php endif; ?>"><?php echo number_format($chiffres["evolution_cumul_sortie_campagne_en_cours"], 0, ',', '&nbsp;'); ?> %</span></h3>
                                ...
                                <?php if ($chiffres["volume_contractualisation"]): ?>
                                    <div class="col">
                                        <div class="chiffre">
                                            <h3 class="mb-0 disable-uppercase"><?php echo number_format($chiffres["volume_contractualisation"], 0, ',', '&nbsp;'); ?> hl <span title="Evolution par rapport à la campagne précédente" class="fs-6 badge <?php if($chiffres["evolution_par_rapport_a_n_1"] >= 0):?>bg-success<?php else: ?>bg-danger <?php endif; ?>"><?php echo number_format($chiffres["evolution_par_rapport_a_n_1"], 0, ',', '&nbsp;'); ?> %</span></h2>
